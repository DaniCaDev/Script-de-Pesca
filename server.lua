...
ESX.RegisterUsableItem('turtlebait', function(source)
	...
	if xPlayer.getInventoryItem('fishingrod').count > 0 then
		...
		TriggerClientEvent('fishing:message', _source, "~g~Colocaste el cebo de tortuga en tu caña de pescar")
	else
...
ESX.RegisterUsableItem('fishbait', function(source)
	...
	if xPlayer.getInventoryItem('fishingrod').count > 0 then
		...
		TriggerClientEvent('fishing:message', _source, "~g~Colocaste el cebo de pescado en tu caña de pescar")
...
ESX.RegisterUsableItem('turtle', function(source)
	...
	if xPlayer.getInventoryItem('fishingrod').count > 0 then
		...
		TriggerClientEvent('fishing:message', _source, "~g~Colocaste la carne de tortuga en la caña de pescar.")
	else
		TriggerClientEvent('fishing:message', _source, "~r~No tienes caña de pescar")
	end
