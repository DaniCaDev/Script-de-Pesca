Config = {}
	...
	---------------------------------------------------------------
	--Time in miliseconds
	Config.FishTime = {a = 44000, b = 64000}
	...
	Config.FishPrice = {a = 220, b = 300} --Will get clean money THIS PRICE IS FOR EVERY 5 FISH ITEMS (5 kg)
	Config.TurtlePrice = {a = 1500, b = 5500} --Will get dirty money
	Config.SharkPrice = {a = 4500, b = 8500} --Will get dirty money
	...
	Config.SellTurtle = {x = 1553.8154296875, y = 3797.630859375, z = 32.420610351563} --Place where players can sell their turtles 
	Config.SellShark = {x = 1931.3011474609, y = 4637.7626953125, z = 38.580219726563} --Place where players can sell their sharks
